...
class Room:
    ...
    def make_choice(self, player):
        ...
        elif self.name == "Cave Room":
            self.solve_riddle(player)

    def solve_riddle(self, player):
        print("A mysterious voice speaks:")
        ...
        if answer.lower() == "echo":
            print("Correct! The door unlocks, revealing a hidden key.")
            self.find_key(player)
        else:
            print("Incorrect answer. The riddle echoes through the cave.")
            self.make_choice(player)

    def get_room_visual(self):
        if self.name == "Forest Room":
            return """
            ~~~~
           /    \\
          ...
          |         |
           \\_______/
            """
        elif self.name == "Mysterious Room":
            return """
            ??????
           ?      ?
           ?      ?
